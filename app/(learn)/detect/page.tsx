...
const SpeechToText = () => {
    ...
    if (isListening) {
      ...
      try {
        ...
        recorder.onstop = async () => {
          ...
          // setPrompt(responseData.transcription)

          // Cleanup: stop the media stream

          //send the prompt to stable-diffusion
          try {
  ...
  return (
    <div className="flex-1 flex flex-row items-center my-[15vh] gap-5 ml-[200px] mt-[200px]">
      {/* cartoon image */}
      <div className="">
      ...
      <div className="flex flex-col items-center gap-y-8 py-5  rounded-3xl shadow-lg  shadow-slate-200">
        ...
        {serverResponse && (
          <div className="felx flex-row">
            <Link href="/worksheet">
              <Button variant="secondary">Go to Your WorkSheets</Button>
            </Link>
            <Button
              className="m-5"
              variant="danger"
